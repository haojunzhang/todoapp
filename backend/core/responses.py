...
from core.exceptions.middleware import (InvalidToken, InvalidSignature, InvalidTimeStamp)
...
ResponseInvalidTimeStamp = generate_response_from_middleware_exception(InvalidTimeStamp)